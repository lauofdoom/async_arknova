 ...
 * </ul>
 *
 * <p>The engine enforces the correct draw count, required discards, and snap availability based on
 * the player's current card strength.
 */
@Component
  ...
  public SubcommandData getSubcommandData() {
    return new SubcommandData("cards", "Draw cards, take a break, or use snap")
        ...
        .addOption(
            OptionType.STRING,
            "discard_ids",
            "Card IDs to discard from hand (comma-separated)",
            false)
        .addOption(
            OptionType.STRING,
            "display_card_ids",
