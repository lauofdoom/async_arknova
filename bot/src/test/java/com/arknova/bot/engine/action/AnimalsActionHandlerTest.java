...
class AnimalsActionHandlerTest {
  ...
  @BeforeEach
  void setUp() {
    handler = new AnimalsActionHandler(deckService, playerCardRepo, cardDefRepo, new ObjectMapper());
  ...
  private CardDefinition animalDef(String id, String name, int baseCost, int minSize,
      String[] requirements, String[] tags, int appeal, int conservation, String abilityText) {
  ...
  class MaxAnimalsTest {
    ...
    @Test @DisplayName("S1 standard → 0") void s1()  { assertThat(maxAnimals(1, false)).isZero(); }
    @Test @DisplayName("S2 standard → 1") void s2()  { assertThat(maxAnimals(2, false)).isEqualTo(1); }
    @Test @DisplayName("S3 standard → 1") void s3()  { assertThat(maxAnimals(3, false)).isEqualTo(1); }
    @Test @DisplayName("S4 standard → 1") void s4()  { assertThat(maxAnimals(4, false)).isEqualTo(1); }
    @Test @DisplayName("S5 standard → 2") void s5()  { assertThat(maxAnimals(5, false)).isEqualTo(2); }

    @Test @DisplayName("S1 upgraded → 1") void s1u() { assertThat(maxAnimals(1, true)).isEqualTo(1); }
    @Test @DisplayName("S2 upgraded → 1") void s2u() { assertThat(maxAnimals(2, true)).isEqualTo(1); } // same
    @Test @DisplayName("S3 upgraded → 2") void s3u() { assertThat(maxAnimals(3, true)).isEqualTo(2); }
    @Test @DisplayName("S4 upgraded → 2") void s4u() { assertThat(maxAnimals(4, true)).isEqualTo(2); }
    @Test @DisplayName("S5 upgraded → 3") void s5u() { assertThat(maxAnimals(5, true)).isEqualTo(3); }
  }
  ...
  class Validation {
    ...
    void tooManyAnimals() {
      ...
      ActionResult result = handler.execute(
          req(Map.of("hand_card_ids", List.of("lion", "fox"),
    ...
    void notAnAnimalCard() {
      ...
      sponsor.setId("s1"); sponsor.setName("Sponsor"); sponsor.setCardType(CardDefinition.CardType.SPONSOR);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(sponsor)));
    ...
    void enclosureNotFound() {
      ...
      CardDefinition def = animalDef("lion", "Lion", 6, 2, new String[]{}, new String[]{}, 3, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void enclosureTooSmall() {
      ...
      CardDefinition def = animalDef("elephant", "Elephant", 10, 5,
          new String[]{}, new String[]{}, 4, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void enclosureFull() {
      ...
      CardDefinition def = animalDef("fox", "Fox", 4, 1, new String[]{}, new String[]{}, 1, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void terrainNotMet() {
      setAnimalsStrength(2);
      CardDefinition def = animalDef("seal", "Seal", 5, 1,
          new String[]{"WATER"}, new String[]{}, 2, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void insufficientMoney() {
      setAnimalsStrength(2);
      player.setMoney(3);
      CardDefinition def = animalDef("lion", "Lion", 10, 2,
          new String[]{}, new String[]{}, 3, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void cannotOverfillSingleEnclosureInOneAction() {
      ...
      player.setMoney(20);
      CardDefinition fox1 = animalDef("fox1", "Fox 1", 4, 1, new String[]{}, new String[]{}, 1, 0, null);
      CardDefinition fox2 = animalDef("fox2", "Fox 2", 4, 1, new String[]{}, new String[]{}, 1, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND))
          .thenReturn(List.of(handCard(fox1), handCard(fox2)));

      ActionResult result = handler.execute(
          req(Map.of("hand_card_ids", List.of("fox1", "fox2"),
                     "hand_enc_ids", List.of("E1", "E1"))),
          player, sharedBoard);
    ...
    void displayInsufficientReputation() {
      ...
      CardDefinition def = animalDef("giraffe", "Giraffe", 6, 2, new String[]{}, new String[]{}, 3, 0, null);
  ...
  class HappyPaths {
    ...
    void strength2PlaceOne() {
      setAnimalsStrength(2);
      player.setMoney(10);
      CardDefinition def = animalDef("lion", "Lion", 6, 2,
          new String[]{}, new String[]{"PREDATOR"}, 3, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void strength5PlaceTwo() {
      ...
      player.setMoney(20);
      CardDefinition lion = animalDef("lion", "Lion", 6, 2, new String[]{}, new String[]{}, 3, 0, null);
      CardDefinition seal = animalDef("seal", "Seal", 4, 1,
          new String[]{"WATER"}, new String[]{}, 2, 0, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND))
      ...
      ActionResult result = handler.execute(
          req(Map.of("hand_card_ids", List.of("lion", "seal"),
    ...
    void upgradedStrength5PlacesThree() {
      ...
      CardDefinition lion = animalDef("lion", "Lion", 6, 2, new String[]{}, new String[]{}, 3, 0, null);
      CardDefinition fox  = animalDef("fox",  "Fox",  4, 1, new String[]{}, new String[]{}, 1, 0, null);
      CardDefinition seal = animalDef("seal", "Seal", 5, 1,
          new String[]{"WATER"}, new String[]{}, 2, 0, null);

      // Add a third enclosure for the display animal
      String board3 = "{\"enclosures\":["
          + "{\"id\":\"E1\",\"size\":3,\"row\":0,\"col\":0,\"tags\":[],\"animalCardIds\":[]},"
          + "{\"id\":\"E2\",\"size\":3,\"row\":1,\"col\":0,\"tags\":[\"WATER\"],\"animalCardIds\":[]},"
    ...
    void displayCardCostIncludesSlotPremium() {
      ...
      player.setMoney(20);
      CardDefinition def = animalDef("bear", "Bear", 6, 1, new String[]{}, new String[]{}, 2, 0, null);
    ...
    void manualResolution() {
      setAnimalsStrength(2);
      player.setMoney(10);
      CardDefinition def = animalDef("owl", "Owl", 4, 1,
          new String[]{}, new String[]{}, 1, 0, "Do something special.");
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
    ...
    void noManualResolution() {
      setAnimalsStrength(2);
      player.setMoney(10);
      CardDefinition def = animalDef("mole", "Mole", 3, 1,
    ...
    void conservationApplied() {
      setAnimalsStrength(2);
      player.setMoney(10);
      CardDefinition def = animalDef("panda", "Giant Panda", 8, 2,
          new String[]{}, new String[]{}, 2, 1, null);
      when(playerCardRepo.findByGameIdAndDiscordIdAndLocationOrderBySortOrderAsc(
          gameId, "player1", CardLocation.HAND)).thenReturn(List.of(handCard(def)));
